...
function Revolutionizing(){
    ...
    <div>
      ...
      <Grid container spacing={0} sx={{paddingTop:'17px',gap:'32px',paddingLeft:'24px'}}>
        <Grid item lg={2.7} sx={{borderRadius:'24px',background:'#FAFAFA'}}>
        {revolutionizingPage.map((post: any) => (
          <div key={post.id}>
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px',
                }}>{post.data.ai_powered}</Typography>
            </div>
            </div>
           ))
        }
          ...
          <div key={post.id}>
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px'
                }}>{post.data.intelligent}</Typography>
            </div>
            </div>
           ))
        }
          ...
          <div key={post.id}>
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px'
                }}>{post.data.job_description}</Typography>
            </div>
            </div>
           ))
        }
          ...
          <div key={post.id}>
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px'
                }}>{post.data.ai_driven}</Typography>
            </div>
            </div>
           ))
        }
      ...
      <Grid container spacing={0} sx={{paddingTop:'29px',gap:'32px',paddingLeft:'24px'}}>
      <Grid item lg={2.7} sx={{borderRadius:'24px',background:'#FAFAFA'}}>
        {revolutionizingPage.map((post: any) => (
          <div key={post.id}>
            <div style={{display:'flex',
            ...
            {post?.data.ai_powered_shortlisting_image && (
                // eslint-disable-next-line @next/next/no-img-element
                <img
                  src={post.data.ai_powered_shortlisting_image.url || undefined}
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px'
                }}>{post.data.ai_powered_shortlisting}</Typography>
            </div>
            </div>
           ))
        }
          ...
          <div key={post.id}>
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px'
                }}>{post.data.smart_interview}</Typography>
            </div>
            </div>
           ))
        }
          ...
          <div key={post.id}>
            ...
            <div style={{display:'flex',
                ...
                <Typography style={{fontFamily:'Poppins',
                    ...
                    fontSize:'30px',
                    lineHeight:'45px'
                }}>{post.data.video_analytics}</Typography>
            </div>
            </div>
           ))
        }
